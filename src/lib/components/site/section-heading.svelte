...
<div class="mb-10 md:mb-14" {@attach reveal()}>
	...
	<div class="mt-3 flex flex-wrap items-end justify-between gap-x-8 gap-y-2">
		<h2 class="font-display text-3xl leading-tight font-medium text-foreground md:text-5xl">
			{title}
		</h2>
		{#if note}
